...
let questions = [
    ...
    new Question("ooo는 탑에서 비스듬하게 친 케이블로 거더교의 하중을 지지하는 교량의 양식이다. 케이블을 사용하기 때문에 케이블교로 분류되며 폭이 넓은 강이나 깊은 계곡 등 비교적 짧은 경간에 적합한 형식이다. 외관상 아름다우나 내풍성이 약하다는 단점이 있다. ooo에 들어갈 교량의 종류로 옳은 것은?", "<br> <img id='img' src='img/q11.jpg'/> </br>", ["사장교", "아치교", "트러스교", "현수교"], "사장교"),
